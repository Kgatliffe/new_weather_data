...
"humidity_24h_Den","wind_speed_24h_Den","rain_1h_24h_Den","rain_3h_24h_Den",
"snow_1h_24h_Den","snow_3h_24h_Den","clouds_all_24h_Den","weather_main_24h_Den_Dummy","Question.1")
...
"humidity_12h_Den","wind_speed_12h_Den","rain_1h_12h_Den",
"rain_3h_12h_Den","snow_1h_12h_Den","snow_3h_12h_Den","clouds_all_12h_Den",
"Question","weather_main_12h_Den_Dummy","weather_main_24h_Den_Dummy",
...
"rain_1h_6h_Den","rain_3h_6h_Den","snow_1h_6h_Den","snow_3h_6h_Den",
...
"wind_speed_3h_Den","rain_1h_3h_Den","rain_3h_3h_Den","snow_1h_3h_Den",
"snow_3h_3h_Den","clouds_all_3h_Den","weather_main_3h_Den_Dummy",
...
"humidity_1h_Den","wind_speed_1h_Den","rain_1h_1h_Den","rain_3h_1h_Den",
"snow_1h_1h_Den","snow_3h_1h_Den","clouds_all_1h_Den","weather_main_1h_Den_Dummy",
...
# include MASS library so we can use stepAIC
	...
	#mod.full <- glm(as.factor(Question) ~ temp_24h_Den
...
# +weather_main_24h_Den_Dummy,family=binomial() ,data=dat.train24)
...
stepAIC(mod.int, direction="both",
	...
	# forward and stepwise yield the same model:
	# Question ~ lcavol + lweight + svi + lbph with AIC= -37.82507

	# backward yields a different model:
	#  Question ~ lcavol + lweight + svi + lbph + age + lcp + pgg45 with AIC=-39.10281

# how about the best subset selection procedure?

...
Avg_Avg=read.csv('Avg_Avg.csv')

q <- ggplot(data = Avg_Avg, aes(x = Hours, y=Averages, group=Group))
q + geom_point() + geom_line()

m <- ggplot(data = Avg_Avg, aes(x = Hours, y=Percent.Change, group=Group, color=Group))

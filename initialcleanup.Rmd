...
{ 
  if (Denver$ind_1[i]==1)
  {
    ...
    sea_level_1h_Den[i]=Denver$sea_level[i-1]    
    grnd_level_1h_Den[i]=Denver$grnd_level[i-1]    
    ...
    rain_24h_1h_Den[i]=Denver$rain_24h[i-1]         
    rain_today_1h_Den[i]=Denver$rain_today[i-1]         
    snow_1h_1h_Den[i]=Denver$snow_1h[i-1]            
    snow_3h_1h_Den[i]=Denver$snow_3h[i-1]            
    snow_24h_1h_Den[i]=Denver$snow_24h[i-1]           
    snow_today_1h_Den[i]=Denver$snow_today[i-1]         
    ...
    weather_icon_1h_Den[i]=Denver$weather_icon[i-1]
  }
}
